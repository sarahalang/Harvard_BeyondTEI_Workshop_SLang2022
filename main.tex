...
\input{einheiten/tei-publication-solutions}\input{einheiten/digital-editing}\input{einheiten/digital-archives}

% lead into XML and TEI
\input{einheiten/xml-tei}
...
%\input{einheiten/regex-annotation}
